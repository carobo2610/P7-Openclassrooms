...
function APropos() {
  ...
  return (
    <main className="APropos">
      <div title="A Propos" description="Section à propos du site Kasa" />
      ...
      <div className="APropos__collapse">
        {items.map((item) => (
          <div className="APropos__collapse--section" key={item.id}>
            <Collapse title={item.title} content={item.text} />
          </div>
        ))}
      </div>
    </main>
